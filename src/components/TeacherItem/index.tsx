...
const TeacherItem: React.FC<TeacherItemProps> = ({ teacher, favored }) => {
    ...
    function handleLinkToWhatsApp() {
        ...
        Linking.openURL(`whatsapp://send?text=Aula de ${teacher.subject}!&phone=+55${teacher.whatsapp}`)
    }
        ...
        <View style={styles.container}>
            ...
            <View style={styles.footer}>
                ...
                <View style={styles.buttonsContainer}>
                    ...
                    >
                        {isFavored && <Image source={unFavoriteIcon} />}
                        {!isFavored && <Image source={heartOutlineIcon} />}
                    </RectButton>
                    <RectButton
